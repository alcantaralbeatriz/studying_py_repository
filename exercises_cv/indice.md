...
__Aula 01 a 05__
   ...
   1. Faça um programa que escreva "Hello world!".

   2. Faça um programa que leia o nome do usuário e mostra uma msg de boas-vindas.

__Aula 06__

   3. Faça um programa que leia dois números e mostre a soma entre eles.

   4. Faça um programa que destrinche o valor de uma variável.
...
__Aula 16__
   ...
   73. Faça um programa com uma tuplca contendo 20 times de futebol na ordem da colocação. Depois mostre: os 5 primeiros colocados; os últimos 4 colocados; os times em ordem alfabética; e em qual posição está o timão.
...
__Aula 17__
   ...
   80. Faça um programa onde o usuário possa digotar 5 valores numéricos e cadastre-os em uma lista, já na posição correta de inserção (sem usar o sort()). No final, mostre a lista ordenada na tela.

   81. Faça um programa que leia vários números e coloque em uma lista. Depois mostre: quantos números foram digitados; a lista de valores ordenada fe forma decrescente; se o valor 5 foi digitado e está ou não na lista.
